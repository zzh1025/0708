<template>
  <div class="box" style="display:inline-block">
    ...
    <el-dialog title="修改水站" :visible.sync="dialogFormVisible">
      <el-form>
        ...
        <el-form-item label="月销售量" :label-width="formLabelWidth">
          <el-input v-model="data.count" autocomplete="off" placeholder="月销售量" type="number"></el-input>
        </el-form-item>
        ...
        <el-form-item label="浏览量" :label-width="formLabelWidth">
          <el-input v-model="data.readNum" autocomplete="off" placeholder="浏览量" type="number"></el-input>
        </el-form-item>
        ...
        <el-form-item label="商家信息" :label-width="formLabelWidth">
          <el-input v-model="data.des" autocomplete="off" placeholder="商家信息"></el-input>
        </el-form-item>
